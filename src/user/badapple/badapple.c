...
static inline int8_t sys_read(void* req, int8_t* rc) {
    syscall_do(0, (uint32_t)req, (uint32_t)rc, 0);
    return *rc;
}
...
static void memset(void *ptr, uint8_t value, uint32_t num) {
