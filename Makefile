...
LFLAGS        = -T $(SOURCE_FOLDER)/kernel/linker.ld -melf_i386
...
kernel:
	...
	@$(CC) $(CFLAGS) $(SOURCE_FOLDER)/kernel/gdt.c -o $(OUTPUT_FOLDER)/gdt.o
	@$(CC) $(CFLAGS) $(SOURCE_FOLDER)/kernel/framebuffer.c -o $(OUTPUT_FOLDER)/framebuffer.o
	@$(CC) $(CFLAGS) $(SOURCE_FOLDER)/kernel/interrupt.c -o $(OUTPUT_FOLDER)/interrupt.o
	@$(CC) $(CFLAGS) $(SOURCE_FOLDER)/kernel/idt.c -o $(OUTPUT_FOLDER)/idt.o
	@$(CC) $(CFLAGS) $(SOURCE_FOLDER)/kernel/portio.c -o $(OUTPUT_FOLDER)/portio.o
	@$(ASM) $(AFLAGS) $(SOURCE_FOLDER)/kernel/intsetup.s -o $(OUTPUT_FOLDER)/intsetup.o
	@$(CC) $(CFLAGS) $(SOURCE_FOLDER)/kernel/keyboard.c -o $(OUTPUT_FOLDER)/keyboard.o
	@$(CC) $(CFLAGS) $(SOURCE_FOLDER)/kernel/paging.c -o $(OUTPUT_FOLDER)/paging.o
	@$(CC) $(CFLAGS) $(SOURCE_FOLDER)/kernel/disk.c -o $(OUTPUT_FOLDER)/disk.o
	@$(CC) $(CFLAGS) $(SOURCE_FOLDER)/kernel/ext2.c -o $(OUTPUT_FOLDER)/ext2.o
	@$(CC) $(CFLAGS) $(SOURCE_FOLDER)/lib/string.c -o $(OUTPUT_FOLDER)/string.o
	@$(CC) $(CFLAGS) $(SOURCE_FOLDER)/kernel/process.c -o $(OUTPUT_FOLDER)/process.o
	@$(CC) $(CFLAGS) $(SOURCE_FOLDER)/kernel/scheduler.c -o $(OUTPUT_FOLDER)/scheduler.o
	@$(CC) $(CFLAGS) $(SOURCE_FOLDER)/kernel/cmos.c -o $(OUTPUT_FOLDER)/cmos.o
	@$(CC) $(CFLAGS) $(SOURCE_FOLDER)/kernel/speaker.c -o $(OUTPUT_FOLDER)/speaker.o
	@$(ASM) $(AFLAGS) $(SOURCE_FOLDER)/kernel/context-switch.s -o $(OUTPUT_FOLDER)/context-switch.o
...
iso: kernel
	...
	@cp $(SOURCE_FOLDER)/kernel/menu.lst $(OUTPUT_FOLDER)/iso/boot/grub/
...
inserter:
	@$(CC) -Wno-builtin-declaration-mismatch -g -I$(SOURCE_FOLDER) \
		$(SOURCE_FOLDER)/lib/string.c \
		$(SOURCE_FOLDER)/kernel/ext2.c \
...
user-shell:
	...
	@$(CC)  $(CFLAGS) -fno-pie $(SOURCE_FOLDER)/lib/string.c -o string.o
	@$(LIN) -T $(SOURCE_FOLDER)/user/user-linker.ld -melf_i386 --oformat=binary crt0.o user-shell.o string.o -o $(OUTPUT_FOLDER)/shell
	@$(LIN) -T $(SOURCE_FOLDER)/user/user-linker.ld -melf_i386 --oformat=elf32-i386 crt0.o user-shell.o string.o -o $(OUTPUT_FOLDER)/shell_elf
	@size --target=binary $(OUTPUT_FOLDER)/shell
	@rm -f *.o

user-clock:
	@$(ASM) $(AFLAGS) $(SOURCE_FOLDER)/user/clock/crt0.s -o crt0.o
	@$(CC)  $(CFLAGS) -fno-pie $(SOURCE_FOLDER)/user/clock/clock.c -o clock.o
	@$(LIN) -T $(SOURCE_FOLDER)/user/clock/linker.ld -melf_i386 --oformat=binary crt0.o clock.o -o $(OUTPUT_FOLDER)/clock
	@size --target=binary $(OUTPUT_FOLDER)/clock
	@rm -f *.o

user-hello:
	@$(ASM) $(AFLAGS) $(SOURCE_FOLDER)/user/hello/crt0.s -o crt0.o
	@$(CC)  $(CFLAGS) -fno-pie $(SOURCE_FOLDER)/user/hello/hello.c -o hello.o
	@$(LIN) -T $(SOURCE_FOLDER)/user/hello/linker.ld -melf_i386 --oformat=binary crt0.o hello.o -o $(OUTPUT_FOLDER)/hello
	@size --target=binary $(OUTPUT_FOLDER)/hello
	@rm -f *.o

user-beep:
	@$(ASM) $(AFLAGS) $(SOURCE_FOLDER)/user/crt0.s -o crt0.o
	@$(CC)  $(CFLAGS) -fno-pie $(SOURCE_FOLDER)/user/user-beep.c -o user-beep.o
	@$(CC)  $(CFLAGS) -fno-pie $(SOURCE_FOLDER)/lib/string.c -o string.o    
	@$(LIN) -T $(SOURCE_FOLDER)/user/user-linker.ld -melf_i386 --oformat=binary crt0.o user-beep.o string.o -o $(OUTPUT_FOLDER)/beep
	@size --target=binary $(OUTPUT_FOLDER)/beep
	@rm -f *.o

user-badapple:
	@$(ASM) $(AFLAGS) $(SOURCE_FOLDER)/user/badapple/crt0.s -o crt0.o
	@$(CC)  $(CFLAGS) -fno-pie $(SOURCE_FOLDER)/user/badapple/badapple.c -o badapple.o
	@$(LIN) -T $(SOURCE_FOLDER)/user/badapple/linker.ld -melf_i386 --oformat=binary crt0.o badapple.o -o $(OUTPUT_FOLDER)/badapple
	@size --target=binary $(OUTPUT_FOLDER)/badapple
	@rm -f *.o

CMD_LINKER = $(SOURCE_FOLDER)/user/command/cmd-linker.ld
CMD_CRT0 = $(SOURCE_FOLDER)/user/command/crt0-cmd.s
...
cmd-pwd:
	...
	@$(CC) $(CFLAGS) -fno-pie $(SOURCE_FOLDER)/user/command/cmd_pwd.c -o cmd_pwd.o
	@$(CC) $(CFLAGS) -fno-pie $(SOURCE_FOLDER)/lib/string.c -o string.o
...
cmd-clear:
	@$(ASM) $(AFLAGS) $(CMD_CRT0) -o crt0-cmd.o
	@$(CC) $(CFLAGS) -fno-pie $(SOURCE_FOLDER)/user/command/cmd_clear.c -o cmd_clear.o
	@$(LIN) -T $(CMD_LINKER) -melf_i386 --oformat=binary crt0-cmd.o cmd_clear.o -o $(OUTPUT_FOLDER)/clear
	@rm -f *.o

cmd-help:
	@$(ASM) $(AFLAGS) $(CMD_CRT0) -o crt0-cmd.o
	@$(CC) $(CFLAGS) -fno-pie $(SOURCE_FOLDER)/user/command/cmd_help.c -o cmd_help.o
	@$(CC) $(CFLAGS) -fno-pie $(SOURCE_FOLDER)/lib/string.c -o string.o
...
cmd-echo:
	@$(ASM) $(AFLAGS) $(CMD_CRT0) -o crt0-cmd.o
	@$(CC) $(CFLAGS) -fno-pie $(SOURCE_FOLDER)/user/command/cmd_echo.c -o cmd_echo.o
	@$(CC) $(CFLAGS) -fno-pie $(SOURCE_FOLDER)/lib/string.c -o string.o
...
cmd-ls:
	@$(ASM) $(AFLAGS) $(CMD_CRT0) -o crt0-cmd.o
	@$(CC) $(CFLAGS) -fno-pie $(SOURCE_FOLDER)/user/command/cmd_ls.c -o cmd_ls.o
	@$(CC) $(CFLAGS) -fno-pie $(SOURCE_FOLDER)/lib/string.c -o string.o
...
cmd-cat:
	@$(ASM) $(AFLAGS) $(CMD_CRT0) -o crt0-cmd.o
	@$(CC) $(CFLAGS) -fno-pie $(SOURCE_FOLDER)/user/command/cmd_cat.c -o cmd_cat.o
	@$(CC) $(CFLAGS) -fno-pie $(SOURCE_FOLDER)/lib/string.c -o string.o
...
cmd-mkdir:
	@$(ASM) $(AFLAGS) $(CMD_CRT0) -o crt0-cmd.o
	@$(CC) $(CFLAGS) -fno-pie $(SOURCE_FOLDER)/user/command/cmd_mkdir.c -o cmd_mkdir.o
	@$(CC) $(CFLAGS) -fno-pie $(SOURCE_FOLDER)/lib/string.c -o string.o
...
cmd-ps:
	@$(ASM) $(AFLAGS) $(CMD_CRT0) -o crt0-cmd.o
	@$(CC) $(CFLAGS) -fno-pie $(SOURCE_FOLDER)/user/command/cmd_ps.c -o cmd_ps.o
	@$(CC) $(CFLAGS) -fno-pie $(SOURCE_FOLDER)/lib/string.c -o string.o
...
cmd-kill:
	@$(ASM) $(AFLAGS) $(CMD_CRT0) -o crt0-cmd.o
	@$(CC) $(CFLAGS) -fno-pie $(SOURCE_FOLDER)/user/command/cmd_kill.c -o cmd_kill.o
	@$(CC) $(CFLAGS) -fno-pie $(SOURCE_FOLDER)/lib/string.c -o string.o
...
cmd-exec:
	@$(ASM) $(AFLAGS) $(CMD_CRT0) -o crt0-cmd.o
	@$(CC) $(CFLAGS) -fno-pie $(SOURCE_FOLDER)/user/command/cmd_exec.c -o cmd_exec.o
	@$(CC) $(CFLAGS) -fno-pie $(SOURCE_FOLDER)/lib/string.c -o string.o
...
cmd-grep:
	@$(ASM) $(AFLAGS) $(CMD_CRT0) -o crt0-cmd.o
	@$(CC) $(CFLAGS) -fno-pie $(SOURCE_FOLDER)/user/command/cmd_grep.c -o cmd_grep.o
	@$(CC) $(CFLAGS) -fno-pie $(SOURCE_FOLDER)/lib/string.c -o string.o
...
cmd-find:
	@$(ASM) $(AFLAGS) $(CMD_CRT0) -o crt0-cmd.o
	@$(CC) $(CFLAGS) -fno-pie $(SOURCE_FOLDER)/user/command/cmd_find.c -o cmd_find.o
	@$(CC) $(CFLAGS) -fno-pie $(SOURCE_FOLDER)/lib/string.c -o string.o
